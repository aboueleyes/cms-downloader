...
def main ():
    ...
    if authenticate_user(username, password) :
        ...
        console.rule("[!] you are not authorized. review your credentials", style="bold red")
        os.remove(".env")
        sys.exit(1)
    ...
    while True:
        ...
        download_links, download_names, discreption, week_name = get_files(course_url, username, password, session)

        item_links, item_names, week_name = choose_files(download_links, download_names, discreption, week_name)
